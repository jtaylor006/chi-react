      ...
      <div className="App" data-spy="scroll" data-target="#navbarResponsive">
        ...
        <div id="home">
          ...
          <nav className="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
            ...
            <div className="collapse navbar-collapse" id="navbarResponsive">
              <ul className="navbar-nav ml-auto">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#summaries">
                    Summaries
                  </a>
                </li>
                {/* <li className="nav-item">
          ...
          <div className="caption text-center">
            ...
            <a className="btn btn-outline-light btn-lg" href="#who">
              Learn More
            </a>
          </div>
        </div>
        ...
        <div id="who" className="offset">
          <div className="col-12 narrow text-center">
            ...
            <p>
              ...
              Chi Dynamic solicits financial backing in order to be able to
              introduce its new product which is described throughout this
              website.
            </p>
          </div>
        </div>
                ...
                <div className="whyTab">
                  <div className="problem">
                    ...
                    <p>
                      ...
                      athletes, taking away valuable time to address, develop,
                      and coach each athlete's technique needs during cardio
                      training sessions.
                    </p>
                  </div>
                </div>
                <div className="whyTab">
                  <div className="solution">
                    ...
                    <p>
                      ...
                      athletes, giving coaches a greater opportunity to coach
                      athlete's form and technique to advance their players to
                      the next performance level without additional time.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="row light text-center">
            ...
            <div className="col-md-4">
              ...
              <p className="lead">
                Two ways:
                <br />
                1. Coach-less cardio training
                <br /> Creates a gamified cardio environment
              </p>
            </div>
            ...
            <div className="col-md-4">
              ...
              <p className="lead">
                Each athlete will have a personalized profile that measure/track
            ...
            <div className="col-md-4">
              ...
              <p className="lead">
                Maximize each athletes speed and agility allowing athletes to
          ...
          <div className="fixed-background">
            <div className="row dark text-center">
              ...
              <div className="col-md-4">
                ...
                <p className="lead">
                  Chi Dynamic was established with the expectation of rapid
                  expansion in the tech industry. 2020 social media trends show
                  that people are embracing new fitness trends along with new
                  workouts which we plan to mesh with the tech industry.{" "}
                </p>
                <a
                  className="btn btn-outline-light btn-lg"
                  href="./executive/executive.html"
                >
                  Read
                </a>
              </div>
              ...
              <div className="col-md-4">
                ...
                <p className="lead">
                  {" "}
                  Sports coaches generally seek out a competitive edge. Chi
                  Dynamic will remove coaching barriers during their athletes
                  cardio training sessions, allowing them to address, develop
                  and coach each athletes technical needs. Coaches will feel
                  like heroes for getting each athlete performing at the top of
                  their ability.
                </p>
                <a
                  className="btn btn-outline-light btn-lg"
              ...
              <div className="col-md-4">
                ...
                <p className="lead">
                  The global sports equipment market size is expected to reach
                  USD 89.22 billion by 2025. Smart fitness equipment provides
                  efficient measurements to track users performance. This has
                  driven the popularity in both exercise and sports tech among
                  sports coaches, athletes and health enthusiasts alike; thereby
                  having a positive impact on market growth.
                </p>
                <a
                  className="btn btn-outline-light btn-lg"
                  href="./marketing/marketing.html"
                >
                  Read
                </a>
              </div>
            ...
            <div className="row justify-content-center">
              <div className="col-md-5 text-center">
                ...
                <p>
                  ...
                  donate towards the Chi Dynamic vision, that opportunity will
                  be featured in a link below as well.
                  <br />
                ...
                <strong>
                  <p>
                    <a
                      ...
                      href="mailto:chidynamiccardio@gmail.com"
                    >
                      Email
                    </a>
                    {/* <br><a
              ...
              <hr class="socket" /> &copy; Chi Dynamic.
            </div>
          </footer>
        </div>
      </div>
